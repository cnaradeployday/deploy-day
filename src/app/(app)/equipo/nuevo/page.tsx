...
export default function NuevoMiembroPage() {
  ...
  const [form, setForm] = useState({
    email: '', full_name: '', role: 'colaborador', hourly_cost: '', password: ''
  })
    ...
    <div className="p-6 max-w-xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">Costo/hora ($)</label>
        ...
        <div className="flex gap-3 pt-2">
          <Link href="/equipo" className="flex-1 text-center py-2.5 border border-gray-200 rounded-xl text-sm text-gray-600 hover:bg-gray-50">
            Cancelar
          </Link>
